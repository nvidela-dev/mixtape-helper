...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center pt-16 pb-24 p-8 relative overflow-hidden">
      ...
      {/* Footer */}
      <div className="absolute bottom-0 left-0 right-0 h-14 bg-brown flex items-center justify-between px-8">
        <a
          href="https://github.com/nvidela-dev/mixtape-helper"
          target="_blank"
          rel="noopener noreferrer"
          className="text-cream/60 hover:text-cream text-sm transition-colors flex items-center gap-2"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="font-display text-2xl text-cream/80 hover:text-cream transition-colors tracking-wide"
        >
          nvidela.dev
        </a>
      </div>
